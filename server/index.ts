...
import { DockerComposeAdapter } from './docker/compose-adapter.js';
...
const adapter = new DockerComposeAdapter(projectRoot, (fields, message) => console.log(JSON.stringify({ level: 'info', time: new Date().toISOString(), ...fields, message })));
