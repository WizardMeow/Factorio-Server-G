...
export const logLevelSchema = z.enum(['info', 'success', 'warning', 'error']);
export const logEntrySchema = z.object({ source: z.enum(['game', 'container', 'startup']), level: logLevelSchema, line: z.string(), timestamp: z.string().datetime().optional() });
